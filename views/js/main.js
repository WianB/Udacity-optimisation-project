...
window.addEventListener("scroll", updatePositions), document.addEventListener("DOMContentLoaded", function() {
    for (var a = 8, b = 256, c = 0; c < 200; c++) {
        var d = document.createElement("img");
        d.className = "mover", d.src = "images/pizza.png", d.style.height = "100px", d.style.width = "73.333px", d.basicLeft = c % a * b, d.style.top = Math.floor(c / a) * b + "px", document.querySelector("#movingPizzas1").appendChild(d)
    }
    updatePositions()
});
